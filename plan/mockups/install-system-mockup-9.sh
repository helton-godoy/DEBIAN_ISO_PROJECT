...
gum style --border-foreground $COLOR_ACCENT --border rounded --padding "1 2" --margin "1 2" \
	"$(gum join --vertical \
		...
		"$(gum style --width 50 "$(gum style --foreground $COLOR_MUTED '  Usuário:')      $(gum style --foreground $COLOR_PRIMARY --bold "$ADM_USER")")" \
...
run_step_mock "Criando usuário $ADM_USER..." 0.5
