...
description: This skill provides pure Bash alternatives to external processes and programs. It should be used when writing Bash scripts that need to avoid external dependencies, improve performance, or handle common tasks like string manipulation, array operations, file handling, and parameter expansion using only Bash built-ins.
license: MIT
metadata:
  category: development
  source:
    repository: https://github.com/dylanaraps/pure-bash-bible
    path: pure-bash-bible
---
